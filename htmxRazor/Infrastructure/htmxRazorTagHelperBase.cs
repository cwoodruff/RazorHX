...
/// <summary>
/// Abstract base class for all htmxRazor tag helpers.
...
/// </summary>
public abstract class htmxRazorTagHelperBase : TagHelper
{
    ...
    /// <summary>
    /// CSS prefix for all htmxRazor components.
    /// </summary>
    ...
    /// </summary>
    protected htmxRazorTagHelperBase(IUrlHelperFactory urlHelperFactory)
    {
    ...
    /// </summary>
    protected htmxRazorTagHelperBase()
    {
