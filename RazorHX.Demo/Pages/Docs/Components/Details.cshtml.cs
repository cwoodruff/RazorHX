...
public class DetailsModel : PageModel
{
    ...
    public string BasicCode => @"<rhx-details rhx-summary=""What is RazorHX?"">
    <p>RazorHX is an ASP.NET Core component library built with
    ...
    public string FaqCode => @"<rhx-details rhx-summary=""How do I install RazorHX?"">
...
<rhx-details rhx-summary=""Is it accessible?"">
    <p>RazorHX uses semantic HTML, ARIA attributes,
